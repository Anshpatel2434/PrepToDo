                ...
                <div className="text-center space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 max-w-4xl mx-auto">
                        <div className="text-center space-y-2">
                            <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-brand-primary-light to-brand-primary-hover-light dark:from-brand-primary-dark dark:to-brand-primary-hover-dark bg-clip-text text-transparent animate-count-up">
                                AI-Powered
                            </div>
                        ...
                        <div className="text-center space-y-2">
                            <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-brand-secondary-light to-cyan-500 dark:from-brand-secondary-dark dark:to-cyan-400 bg-clip-text text-transparent animate-count-up delay-200">
                                Smart
                            </div>
                            <div className={`text-sm font-medium ${
                                isDark 
                        ...
                        <div className="text-center space-y-2">
                            <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-brand-accent-light to-orange-500 dark:from-brand-accent-dark dark:to-orange-400 bg-clip-text text-transparent animate-count-up delay-400">
                                Personalized
                            </div>
                            <div className={`text-sm font-medium ${
                                isDark 
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <button
                            className={`
                                ...
                                ${isDark 
                                    ? "bg-gradient-to-r from-brand-primary-dark to-brand-primary-hover-dark" 
                                    : "bg-gradient-to-r from-brand-primary-light to-brand-primary-hover-light"
                                }
                            `}
                        >
                            ...
                            <div className={`absolute inset-0 opacity-0 transition-opacity duration-300 ${
                                isDark 
                                    ? "bg-gradient-to-r from-brand-primary-hover-dark to-brand-accent-dark" 
                                    : "bg-gradient-to-r from-brand-primary-hover-light to-brand-accent-light"
                            }`} />
                        </button>
                    ...
                    {/* Trust indicators */}
                    <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center pt-4 text-sm ${
                        isDark 
                            ? "text-text-muted-dark" 
                            : "text-text-muted-light"
                    }`}>
