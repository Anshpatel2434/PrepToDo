...
export const Footer: React.FC<FooterProps> = ({
    ...
    return (
        <footer
            className={`
                relative py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden transition-colors duration-300 border-t
                ${
                    isDark
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <motion.div
                                className={`relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center shadow-lg transition-colors duration-300 ${
                                    isDark
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                <motion.button
                                    className={`
                                        ...
                                        ${
                                            isDark
                                                ? "bg-brand-primary-dark text-text-primary-dark hover:bg-brand-primary-hover-dark"
                                    ...
                                    {section.links.map((link, idx) => (
                                        ...
                                        >
                                            <motion.a
                                                href={link.href}
                                                className={`
                                                    transition-colors duration-300 text-xs sm:text-sm relative group inline-block
                                                    ${
                                                        isDark
                                            ...
                                            >
                                                ...
                                                <motion.div
                                                    className={`absolute inset-0 rounded-lg scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left -z-0 ${
                                                        isDark
                ...
                {/* Divider */}
                <motion.div
                    className={`h-px transition-colors duration-300 mb-8 sm:mb-12 lg:mb-16 ${
                ...
                >
                    {/* Copyright */}
                    <motion.div
                        className={`flex flex-col sm:flex-row items-center gap-2 text-xs sm:text-sm text-center sm:text-left transition-colors duration-300 ${
                            isDark ? "text-text-muted-dark" : "text-text-muted-light"
                        }`}
                        variants={itemVariants}
                    >
                        ...
                        <motion.div
                            className={`hidden sm:block w-1 h-1 rounded-full transition-colors duration-300 ${
                    ...
                    {/* Trust indicators */}
                    <motion.div
                        className={`flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-xs sm:text-sm transition-colors duration-300 ${
                            isDark ? "text-text-muted-dark" : "text-text-muted-light"
                        }`}
                        variants={itemVariants}
                    >
