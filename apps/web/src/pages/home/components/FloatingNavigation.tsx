...
export const FloatingNavigation: React.FC<FloatingNavigationProps> = ({ onNavigate }) => {
  ...
  return (
    <>
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className={`text-2xl font-serif font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  PrepToDo
                </h1>
                ...
                {hoveredItem === item.id && (
                  ...
                  `}>
                    ...
                    <div className={`
                      ...
                      ${isDark ? 'bg-slate-800 border-l border-b border-slate-600' : 'bg-white border-l border-b border-gray-200'}
                    `} />
                  </div>
                )}
              </div>
      ...
      <div className={`
        ...
        ${isOpen ? 'translate-x-20 opacity-0 pointer-events-none' : 'translate-x-0 opacity-100 pointer-events-auto'}
      `}>
        {navigationItems.map((item) => (
          <div
            key={item.id}
