				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0 sm:min-w-[280px]">
					...
					>
						<div className="flex items-center gap-2 mb-1">
							<span className="text-brand-primary-light dark:text-brand-primary-dark text-sm">
								⏱️
							</span>
							<div
					...
					>
						<div className="flex items-center gap-2 mb-1">
							<span className="text-brand-accent-light dark:text-brand-accent-dark text-sm">
								🎯
							</span>
							<div
								className={`text-xs font-medium uppercase tracking-wide ${
