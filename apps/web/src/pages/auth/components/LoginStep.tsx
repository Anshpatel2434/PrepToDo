    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`
                ...
                ${isDark ? 'text-text-muted-dark hover:text-text-secondary-dark' : 'text-text-muted-light hover:text-text-secondary-light'}
              `}
            >
        ...
        <div className="space-y-3 pt-2">
          <button
            type="submit"
            disabled={isLoading || !email || !password || !EmailService.isValidEmail(email)}
            className={`
              w-full py-3 px-4 rounded-xl font-medium transition-all duration-200
              ${isLoading || !email || !password || !EmailService.isValidEmail(email)
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`
                px-2 
                ${isDark ? 'bg-bg-secondary-dark text-text-secondary-dark' : 'bg-bg-secondary-light text-text-secondary-light'}
              `}>
                Or
              </span>
            </div>
          ...
          <button
            ...
            disabled={isLoading}
            className={`
              w-full py-3 px-4 rounded-xl font-medium transition-all duration-200 border-2
              ${isLoading
                ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                : isDark 
