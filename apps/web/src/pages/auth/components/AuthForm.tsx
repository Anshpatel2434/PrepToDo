...
export const AuthForm: React.FC<AuthFormProps> = ({
    ...
    useEffect(() => {
        const currentStep = authState?.signupStep || 1;
        if (isSignupStep1 !== (currentStep === 1)) {
            setIsSignupStep1(currentStep === 1);
        }
        if (isSignupStep2 !== (currentStep === 2)) {
            setIsSignupStep2(currentStep === 2);
        }
        if (isSignupStep3 !== (currentStep === 3)) {
            setIsSignupStep3(currentStep === 3);
        }
    }, [authState, isSignupStep1, isSignupStep2, isSignupStep3]);
