...
import {
	...
	setSolutionViewType, // Ensure this action is exported from your slice
...
export const SolutionToggle: React.FC<SolutionToggleProps> = ({
	...
	const viewType = useSelector(selectSolutionViewType);

	const getBtnStyle = (type: "common" | "personalized") => {
