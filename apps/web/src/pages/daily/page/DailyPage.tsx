			...
			<div className="container mx-auto px-6 py-16">
				...
				>
					...
					<ul
						...
						`}
					>
						<li>✓ Timed practice sessions with real-time tracking</li>
						<li>✓ Detailed solutions and AI-powered insights</li>
						<li>✓ Mark questions for review and revisit anytime</li>
