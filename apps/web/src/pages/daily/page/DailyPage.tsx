...
const DailyPage: React.FC = () => {
	...
	const handleStartPractice = async (type: "rc" | "va") => {
		...
		try {
			...
			console.log("This is the test data that we fetched : ");
			...
			if (existingSession && !existingSessionError) {
				...
				console.log(
					"Resuming existing session and these below are the details :",
			...
			if (type === "rc") {
				...
				console.log("Starting a new session for rc and details are : ");
				console.log(session);
				if (session) {
				...
				console.log("Starting a new session for va and details are : ");
				console.log(session);
				if (session) {
