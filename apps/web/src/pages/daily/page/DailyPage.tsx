...
const DailyPage: React.FC = () => {
    ...
    const handleStartPractice = async (type: "rc" | "va") => {
        ...
        try {
            ...
            console.log('[DailyPage] Checking for existing session of type:', sessionType);
            ...
            if (existingSession && !existingSessionError) {
                ...
                console.log('[DailyPage] Resuming existing session:', existingSession.session.id);
                console.log('[DailyPage] Existing attempts:', existingSession.attempts.length);
            ...
            console.log('[DailyPage] No existing session found, starting new session');
