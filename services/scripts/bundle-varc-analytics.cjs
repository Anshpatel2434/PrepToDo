// services/scripts/bundle-varc-analytics.cjs
// Bundles varc-analytics worker for Deno Edge Runtime

// Import esbuild from local node_modules
...
async function bundleFunction() {
    try {
        console.log("🔨 Bundling varc-analytics function...");
        ...
        const entryPoint = resolve(
            servicesDir,
            "workers/varc-analytics/runVarcAnalytics.ts"
        );
        console.log("📍 Entry point:", entryPoint);
        console.log("");

        // Bundle services code
...
// DO NOT EDIT - This file is auto-generated by: npm run bundle:varc-analytics
...
`;
        ...
        const outputDir = resolve(rootDir, "supabase/functions/analyze-varc-session");
        ...
        writeFileSync(outputPath, bundledCode, "utf8");
        ...
        console.log("  cd .. && supabase functions deploy analyze-varc-session");
    } catch (err) {
