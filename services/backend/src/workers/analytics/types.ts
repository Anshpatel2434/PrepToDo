...
export const PracticeSessionSchema = z.object({
    id: z.string(),
    user_id: z.string(),
    paper_id: z.string().nullish(), // Made nullish as it handles empty paper_id now
    session_type: z.enum([
        "practice",
        "timed_test",
        "daily_challenge_rc",
    ...
    question_ids: z.array(z.string()).nullish(), // Made nullish
    ...
    time_spent_seconds: z.number(),
    started_at: z.string(),
    completed_at: z.string().nullish(), // Made nullish
    paused_at: z.string().nullish(),
    pause_duration_seconds: z.number().nullish(), // Made nullish
    total_questions: z.number().nullish(), // Made nullish
    correct_answers: z.number().nullish(), // Made nullish
    current_question_index: z.number().nullish(), // Made nullish
    is_group_session: z.boolean().nullish(), // Made nullish
    group_id: z.string().nullish(),
    status: z.enum(["in_progress", "completed", "abandoned", "paused"]).nullish(), // Made nullish
    score_percentage: z.number().nullish(), // Made nullish
    points_earned: z.number().nullish(), // Made nullish
    created_at: z.string(),
    updated_at: z.string().nullish(), // Made nullish
...
export const PassageSchema = z.object({
    ...
    is_daily_pick: z.boolean().nullish(), // Made nullish
    is_featured: z.boolean().nullish(), // Made nullish
    is_archived: z.boolean().nullish(), // Made nullish
    created_at: z.string(),
    updated_at: z.string(),
});
