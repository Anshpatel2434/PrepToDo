// =============================================================================
// Daily Content Worker - Entity Builder
// =============================================================================
// Clean utilities for creating and managing entities
...
/**
 * Update questions with rationales and tags (combined)
 */
export function updateQuestionsWithRationalesAndTags(
    dataManager: DataManager,
    questionsWithData: Array<{ id: string; rationale: string; tags: string[] }>
): void {
...
/**
 * Helper to get questions for processing
 */
