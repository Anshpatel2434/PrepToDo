// =============================================================================
// Daily Content Worker - Format Output For DB
// =============================================================================
// Simplified formatter that works with DataManager - no DB changes needed

import { DataManager } from "./dataManager";
import { Exam, Passage, Question } from "../types";
import { createChildLogger } from "../../../common/utils/logger.js";

const logger = createChildLogger('output-formatter');
...
export function formatOutputForDB(
    ...
    try {
        ...
        logger.info(`   - Passage: ${passage.word_count} words, ${passage.genre}`);
